            ...
            ZStack(alignment: .top) {
                ...
                VStack(spacing: 0) {
                    GeometryReader { geometry in
                        ...
                        let isCompact = screenWidth < 600 // Define threshold for compact vs regular
                        
                        ZStack(alignment: .top) { // Changed alignment to .top
                            VisualEffectBlur(blurStyle: .systemMaterial) // Apply the blur effect
                                ...
                                .frame(height: showTopControls ? (isCompact ? 200 : 100) : 0) // Set height based on isCompact and showTopControls
                    ...
                    // Fix the height of the GeometryReader to the desired height
                }
            }
